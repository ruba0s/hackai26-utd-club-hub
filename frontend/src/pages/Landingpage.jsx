    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
          <p style={{ fontFamily: FONT, fontSize: "1rem", color: MU, maxWidth: 520, lineHeight: 1.8, letterSpacing: "0.2px" }}>
            300+ student orgs. One personalized calendar,<br />AI-matched to your interests.
          </p>
          <p style={{ fontFamily: FONT, fontSize: "0.88rem", color: "#3d3d3d", maxWidth: 520, lineHeight: 1.8, letterSpacing: "0.2px" }}>
